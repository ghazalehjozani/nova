...
public interface IrregularDisbursementRequestToCommandMapper {

    IrregularDisbursementCommand toCommand(UUID loanFacilityId, IrregularDisbursementRequest request);
}
