...
public record DefineLoanTypeRequest(
        ...
        @Schema(description = "محل استفاده", requiredMode = Schema.RequiredMode.REQUIRED) GatewayType gatewayType,
    ...
    public record EconomicSectorCurrencyDto(
            ...
            @Schema(description = "نوع ارز", requiredMode = Schema.RequiredMode.REQUIRED) Set<String> currencyTypes) {}
    ...
    public record RelationTypeLoanTopicDto(
            ...
            @Schema(description = "نام موضوع مرتبط", requiredMode = Schema.RequiredMode.REQUIRED) String topicName,
            @Schema(description = "کد موضوع مرتبط", requiredMode = Schema.RequiredMode.REQUIRED) String topicCode,
