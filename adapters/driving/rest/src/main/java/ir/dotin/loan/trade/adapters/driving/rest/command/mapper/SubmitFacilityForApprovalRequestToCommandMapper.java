...
public interface SubmitFacilityForApprovalRequestToCommandMapper {

    SubmitFacilityForApprovalCommand toCommand(UUID loanFacilityId, SubmitFacilityForApprovalRequest request);
}
