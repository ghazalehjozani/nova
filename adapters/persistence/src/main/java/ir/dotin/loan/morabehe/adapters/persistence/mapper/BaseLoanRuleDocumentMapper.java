...
import ir.dotin.loan.baseloan.adapters.persistence.document.base.CurrencyDocument;
import ir.dotin.loan.baseloan.adapters.persistence.document.base.DurationRangeDocument;
import ir.dotin.loan.baseloan.adapters.persistence.document.base.EconomicSectorsDocument;
import ir.dotin.loan.baseloan.adapters.persistence.document.base.MoneyRangeDocument;
import ir.dotin.loan.baseloan.adapters.persistence.document.base.RateRangeDocument;
import ir.dotin.loan.baseloan.adapters.persistence.document.loanrule.BaseLoanRuleDocument;
import ir.dotin.loan.baseloan.adapters.persistence.document.loanrule.subdocuments.CollateralPolicyDocument;
import ir.dotin.loan.baseloan.adapters.persistence.document.loanrule.subdocuments.CollateralTypeDocument;
import ir.dotin.loan.baseloan.adapters.persistence.document.loanrule.subdocuments.ConfirmTypeDocument;
import ir.dotin.loan.baseloan.adapters.persistence.document.loanrule.subdocuments.GracePeriodPolicyDocument;
import ir.dotin.loan.baseloan.adapters.persistence.document.loanrule.subdocuments.InstallmentPolicyDocument;
import ir.dotin.loan.baseloan.adapters.persistence.document.loanrule.subdocuments.InterestPolicyDocument;
import ir.dotin.loan.baseloan.adapters.persistence.document.loanrule.subdocuments.PenaltyPolicyDocument;
import ir.dotin.loan.baseloan.adapters.persistence.document.loanrule.subdocuments.RegulatoryCompliancePolicyDocument;
import ir.dotin.loan.baseloan.adapters.persistence.document.loanrule.subdocuments.RepaymentPriorityPolicyDocument;
