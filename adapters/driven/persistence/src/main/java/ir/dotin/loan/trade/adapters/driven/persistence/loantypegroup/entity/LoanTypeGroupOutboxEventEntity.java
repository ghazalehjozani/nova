...
@Entity
@Table(name = "loan_type_groups_outbox_events")
@NoArgsConstructor
@Getter
@Setter
public class LoanTypeGroupOutboxEventEntity extends AbstractOutboxEventEntity {

    @ElementCollection(fetch = FetchType.LAZY)
    @CollectionTable(name = "loan_type_groups_outbox_metadata", joinColumns = @JoinColumn(name = "outbox_event_id"))
    ...
    public final boolean equals(Object o) {
        ...
        LoanTypeGroupOutboxEventEntity that = (LoanTypeGroupOutboxEventEntity) o;
