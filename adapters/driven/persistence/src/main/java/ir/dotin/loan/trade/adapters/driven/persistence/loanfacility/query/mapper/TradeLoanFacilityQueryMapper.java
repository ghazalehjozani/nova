...
public interface TradeLoanFacilityQueryMapper {
    ...
    @Mapping(target = "sanctionedLoan.approvedAmountCurrency", source = "sanctionedLoan.approvedAmount.currency")
    @Mapping(target = "sanctionedLoan.approvedAmountAmount", source = "sanctionedLoan.approvedAmount.amount")
