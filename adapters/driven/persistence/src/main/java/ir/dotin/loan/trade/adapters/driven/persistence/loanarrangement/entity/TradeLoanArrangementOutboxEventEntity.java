...
public class TradeLoanArrangementOutboxEventEntity extends AbstractOutboxEventEntity {
    ...
    @CollectionTable(name = "loan_arrangement_outbox_metadata", joinColumns = @JoinColumn(name = "outbox_event_id"))
    ...
    public final boolean equals(Object o) {
        ...
        TradeLoanArrangementOutboxEventEntity that = (TradeLoanArrangementOutboxEventEntity) o;
