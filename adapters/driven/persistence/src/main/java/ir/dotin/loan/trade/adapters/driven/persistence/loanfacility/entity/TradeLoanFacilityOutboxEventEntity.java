...
public class TradeLoanFacilityOutboxEventEntity extends AbstractOutboxEventEntity {
    ...
    @CollectionTable(name = "loan_facility_outbox_metadata", joinColumns = @JoinColumn(name = "outbox_event_id"))
    ...
    public final boolean equals(Object o) {
        ...
        TradeLoanFacilityOutboxEventEntity that = (TradeLoanFacilityOutboxEventEntity) o;
