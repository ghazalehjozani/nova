...
@Component
public class MorabeheLoanTypeEntryMapper extends BaseLoanTypeEntryMapper<LoanType, LoanType.LoanTypeBuilder> {
    ...
    public MorabeheLoanTypeEntry mapToDocument(MorabeheLoanType loanType) {
        ...
        document.setHasIssueMerchandiseDocument(loanType.getLoanType().hasIssueMerchandiseDocument());
        document.setLoanRuleIds(
                mapSet(loanType.getLoanType().loanRuleIds(), id -> id.value().toString()));
    ...
    public MorabeheLoanType mapToAggregate(MorabeheLoanTypeEntry document) {
        ...
        var loanTypeBuilder = new LoanType.LoanTypeBuilder()
                .withLoanRuleIds(mapSet(document.getLoanRuleIds(), id -> new MorabeheLoanRuleId(UUID.fromString(id))));
        loanTypeBuilder.withHasIssueMerchandiseDocument(document.getHasIssueMerchandiseDocument());
