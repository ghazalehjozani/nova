...
public enum FcbErrorCode {
    ...
    CMPLEXPEND_757(FcbBusinessLocalizedMessageCodes.INVALID_ACCOUNT_NUMBER, Set.of("accountNumber")),
    CMPLEXPEND_760(FcbBusinessLocalizedMessageCodes.INVALID_FILE_NUMBER, Set.of("fileNumber")),
