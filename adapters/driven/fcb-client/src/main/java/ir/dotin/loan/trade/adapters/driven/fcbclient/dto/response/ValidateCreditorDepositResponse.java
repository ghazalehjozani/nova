...
@XStreamAlias("com.fanap.business.cmplexpenditure.dto.ValidateCreditorDepositResultDTO")
public class ValidateCreditorDepositResponse extends FcbBaseResponse {

    @XStreamAlias("isCreditor")
