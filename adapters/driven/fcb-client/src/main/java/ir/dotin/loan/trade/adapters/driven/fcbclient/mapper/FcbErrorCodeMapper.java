...
public class FcbErrorCodeMapper {
    ...
    public Notification mapRsCodeToNotification(FcbBaseResponse response, Object... args) {
        ...
        if (Objects.isNull(rsCode) || rsCode.trim().isEmpty()) {
            return Notification.ofError(FcbBusinessLocalizedMessageCodes.FCB_UNKNOWN_ERROR, args);
        }
        ...
        Object[] contextArgs = args.length > 0 ? args : new Object[] {errorMessage};
