 ...
 *
 * <p>Holds the wire DTOs (polymorphic {@code FcbBaseRequest}/{@code FcbBaseResponse} keyed on {@code operationName}),
 * the domain⇄wire mappers, the FCB error/exception taxonomy, the request/reply abstraction
