...
# فهرست typeهای ثبت‌شده — دادهٔ مرجع است، پس بیرون از /ops و بدون نیاز به هویت اپراتور
curl -sH "Accept-Language: fa" "$NOVA/v1/reference/reconciliation-types"
# [{"code":"facility-state","label":"وضعیت تسهیلات"}]
```
