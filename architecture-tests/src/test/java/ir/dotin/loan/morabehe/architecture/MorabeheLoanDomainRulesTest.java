package ir.dotin.loan.morabehe.architecture;
...
@AnalyzeClasses(packages = "ir.dotin.loan.morabehe.core.domain", importOptions = ImportOption.DoNotIncludeTests.class)
public class MorabeheLoanDomainRulesTest {

    private static final String MORABEHE_LOAN_PREFIX = "ir.dotin.loan.morabehe.";
    ...
    public static final ArchRule domain_should_not_depend_on_application = noClasses()
            ...
            .as("Morabehe Loan: Domain layer should not depend on Application layer");
    ...
    public static final ArchRule domain_should_not_depend_on_ports = noClasses()
            ...
            .as("Morabehe Loan: Domain layer should not depend on Port layer");
    ...
    public static final ArchRule domain_should_not_depend_on_adapters = noClasses()
            ...
            .as("Morabehe Loan: Domain layer should not depend on Adapters layer");
