package ir.dotin.loan.trade.core.application.service.submitfacilityforapproval.compensation.step;
...
import ir.dotin.loan.trade.core.application.service.submitfacilityforapproval.compensation.commandhandler.CompensateApprovalSubmissionCommandHandler;
...
public class RevertApprovalSubmissionStep implements WriteActivity<CompensateApprovalSubmissionCommandHandler.Data> {
    ...
    public StepResult<List<DomainEvent<?>>> execute(
        ...
        var result = Result.fromOptional(
                ...
                .flatMap(facility -> facility.revertApprovalSubmission(clock).map(v -> facility))
