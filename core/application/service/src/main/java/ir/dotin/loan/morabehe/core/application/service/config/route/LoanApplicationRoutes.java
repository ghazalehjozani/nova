...
public final class LoanApplicationRoutes extends BaseRoutes {
    ...
    public static final class SagaRoutes {
        ...
        public static final String CREATE_LOAN_APPLICATION_SAGA_COMPENSATION =
                CREATE_LOAN_APPLICATION_SAGA + BaseRoutes.SagaRoutes.COMPENSATION;

        public static final String APPROVE_LOAN_APPLICATION_SAGA = "ApproveLoanApplicationSaga";
        public static final String APPROVE_LOAN_APPLICATION_SAGA_COMPENSATION =
                APPROVE_LOAN_APPLICATION_SAGA + BaseRoutes.SagaRoutes.COMPENSATION;
    ...
    public static final class ApiEndpoints {
        ...
        public static final String BASE_GRAPHQL_PATH =
                BaseRoutes.ApiEndpoints.BASE_PATH + BaseRoutes.ApiEndpoints.GRAPHQL_PATH + "/loan-application";
