...
public record AddFacilityCollateralSagaData(
    ...
    public static AddFacilityCollateralSagaData initial(
        ...
        return new AddFacilityCollateralSagaData(facilityId, requestId, collaterals, List.of(), List.of());
    }

    public AddFacilityCollateralSagaData withReservedSerials(List<String> serials) {
        return new AddFacilityCollateralSagaData(facilityId, requestId, collaterals, serials, capturedEvents);
    }

    public AddFacilityCollateralSagaData withCapturedEvents(List<CapturedEventData> events) {
        return new AddFacilityCollateralSagaData(facilityId, requestId, collaterals, reservedSerials, events);
    }
