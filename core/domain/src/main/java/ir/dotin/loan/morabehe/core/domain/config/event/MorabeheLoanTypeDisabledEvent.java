...
public record MorabeheLoanTypeDisabledEvent(UUID eventId, Instant createdAt, UUID aggregateId)
        implements DomainEvent<MorabeheLoanTypeDisabledEvent, Object> {
