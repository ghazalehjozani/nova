// package ir.dotin.loan.trade.core.domain.disbursement.service;
//
...
// import ir.dotin.loan.trade.core.domain.disbursement.strategy.*;
...
//    // application service
//
//    private final DocumentFactory transactionFactory;
...
//            DocumentFactory transactionFactory,
...
//        this.transactionFactory = requireNonNull(transactionFactory);
//        this.externalTransactionPostingClient = requireNonNull(externalTransactionPostingClient);
//        this.loanTopicResolver = requireNonNull(loanTopicResolver);
//        this.strategyProvider = requireNonNull(strategyProvider);
//    }
//
//    public Result<List<TransactionNumber>> generateAndPostDisbursementTransactions(TradeLoanFacility facility) {
...
//
//        try {
//            Result<CalculationContext<TradeLoanFacility>> contextResult = prepareCalculationContext(facility);
...
//                    applicableStrategies = strategyProvider.getStrategies(facility);
...
//                    .map(strategy ->
//                            CompletableFuture.supplyAsync(() -> createTransactionData(contextResult.value(),
// strategy)))
//                    .toList();
//
...
//                            TradeLoanFacilityLocalizedMessageCodes.TRANSACTION_POSTING_FAILED, data.purposeCode);
//                }
//            }
//
//            if (!accumulatedNotification.isEmpty()) {
...
//                    .addError(TradeLoanFacilityLocalizedMessageCodes.UNEXPECTED_ERROR, e.getMessage());
//            return Result.failure(notification);
//        }
//    }
//
//    private Result<Void> validateFacilityForDisbursement(TradeLoanFacility facility) {
//        Notification notification = Notification.create();
...
//                    TradeLoanFacilityLocalizedMessageCodes.CANNOT_POST_DISBURSE_TRANSACTION, currentState.name());
//            return Result.failure(notification);
//        }
//
...
//    }
//
//    private Result<CalculationContext<TradeLoanFacility, TradeRelationType, DisbursedInterestArticleType>>
//            prepareCalculationContext(TradeLoanFacility facility) {
//        requireNonNull(facility, "MorabeheLoanFacility cannot be null for preparing CalculationContext.");
//        Notification accumulatedNotification = Notification.create();
//
//        // 1. Resolve LoanTopic
...
//                    TradeLoanFacilityLocalizedMessageCodes.CALCULATION_CONTEXT_LOAN_APPLICATION_MISSING_IN_FACILITY);
//            return Result.failure(accumulatedNotification);
//        }
//
...
//            accumulatedNotification = accumulatedNotification.addError(
//                    TradeLoanFacilityLocalizedMessageCodes.CALCULATION_CONTEXT_ECONOMIC_SECTOR_MISSING);
//            return Result.failure(accumulatedNotification);
//        }
//
...
//            accumulatedNotification = accumulatedNotification.addError(
//                    TradeLoanFacilityLocalizedMessageCodes.LOAN_TOPIC_RESOLUTION_FAILED,
...
//            accumulatedNotification = accumulatedNotification.addError(
//                    TradeLoanFacilityLocalizedMessageCodes.CALCULATION_CONTEXT_APPLICATION_NUMBER_MISSING);
//            return Result.failure(accumulatedNotification);
//        }
...
//            accumulatedNotification = accumulatedNotification.addError(
//                    TradeLoanFacilityLocalizedMessageCodes.CALCULATION_CONTEXT_POST_TITLE_CREATION_FAILED,
//                    applicationNumber.derivedValue());
//            return Result.failure(accumulatedNotification);
//        }
//        PostTitle postTitle = postTitleResult.value();
//
//        Result<CalculationContext<TradeLoanFacility>> contextResult =
...
//            Notification notification = Notification.create()
//                    .addError(
//                            TradeLoanFacilityLocalizedMessageCodes.UNKNOWN_STRATEGY_TYPE,
...
//    }
//
//    private String determinePurposeCode(
//            DocumentCalculationStrategy<TradeLoanFacility, TradeRelationType, DisbursedInterestArticleType> strategy)
// {
