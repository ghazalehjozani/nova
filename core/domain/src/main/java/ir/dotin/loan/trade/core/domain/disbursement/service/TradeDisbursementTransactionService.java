...
public final class TradeDisbursementTransactionService {
    ...
    public Result<List<TransactionNumber>> generateAndPostDisbursementTransactions(TradeLoanFacility facility) {
        ...
        try {
            ...
            List<DocumentCalculationStrategy<TradeLoanFacility>> applicableStrategies =
    ...
    private Result<CalculationContext<TradeLoanFacility>> prepareCalculationContext(TradeLoanFacility facility) {
    ...
    private Result<TransactionData> createTransactionData(
            CalculationContext<TradeLoanFacility> context, DocumentCalculationStrategy<TradeLoanFacility> strategy) {
    ...
    private String determinePurposeCode(DocumentCalculationStrategy<TradeLoanFacility> strategy) {
