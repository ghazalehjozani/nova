...
public record MorabeheLoanApplicationDisbursedEvent(UUID eventId, Instant createdAt, UUID aggregateId)
        implements DomainEvent<MorabeheLoanApplicationDisbursedEvent, Object> {
    ...
    public static MorabeheLoanApplicationDisbursedEvent of(MorabeheLoanApplicationId aggregateId) {
