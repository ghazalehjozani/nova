package ir.dotin.loan.morabehe.core.domain.loantype.enums;
...
public enum MorabeheRelationType implements RelationType<MorabeheRelationType> {
    ...
    MorabeheRelationType(String localizableName, Direction direction) {
