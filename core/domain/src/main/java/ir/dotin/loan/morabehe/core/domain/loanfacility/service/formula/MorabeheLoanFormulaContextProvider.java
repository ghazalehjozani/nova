...
import ir.dotin.loan.baseloan.core.domain.loanfacility.service.formula.BaseLoanFormulaContextProvider;
...
@DomainService
public final class MorabeheLoanFormulaContextProvider
        extends BaseLoanFormulaContextProvider<
                BaseFormulaField,
                MorabeheLoanFacility,
                MorabeheLoanArrangementId,
                MorabeheLoanArrangement,
                MorabeheFieldValueResolver> {

    public MorabeheLoanFormulaContextProvider(MorabeheLoanArrangementDataProvider arrangementDataProvider) {
        super(arrangementDataProvider);
    }

    @Override
    protected Map<BaseFormulaField, MorabeheFieldValueResolver> initializeFieldResolvers() {
        Map<BaseFormulaField, MorabeheFieldValueResolver> resolvers = new EnumMap<>(BaseFormulaField.class);
