package ir.dotin.loan.morabehe.core.domain.shared.service;
    ...
    public Result<TransactionMetadata> resolveTransactionMetadata(
        ...
        if (defaultMetadataResult.isFailure()) {
            notification = notification
                    ...
                    .addError(MorabeheDisbursementLocalizedMessageCodes.TRANSACTION_METADATA_DEFAULT_CREATION_FAILED);
            return Result.failure(notification);
        }
