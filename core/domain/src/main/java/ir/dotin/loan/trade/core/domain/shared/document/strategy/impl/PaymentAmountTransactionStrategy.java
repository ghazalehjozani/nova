...
import ir.dotin.loan.trade.core.domain.shared.document.strategy.CashMovementStrategy;
...
public final class PaymentAmountTransactionStrategy
    ...
    public PaymentAmountTransactionStrategy(
            DebitCreditArticleSpecFactory<PaymentAmountArticleType, TradeRelationType> specFactory,
