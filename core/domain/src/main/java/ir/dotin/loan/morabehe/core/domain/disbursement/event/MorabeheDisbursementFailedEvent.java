...
public record MorabeheDisbursementFailedEvent(
        UUID eventId, MorabeheDisbursementRecordId aggregateId, FailureReason payload, Instant createdAt)
        implements MorabeheDisbursementEvent<MorabeheDisbursementFailedEvent, FailureReason> {

    public static final String FAILED = "FAILED";

    public MorabeheDisbursementFailedEvent {
