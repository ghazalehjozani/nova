...
public class PaymentAmountMetadataConfig implements MetadataConfig<PaymentAmountArticleType, TradeRelationType> {
    ...
    private static final Map<PaymentAmountArticleType, List<MetadataSection>> TYPE_SPECIFIC_SECTIONS = ImmutableMap.of(
            PaymentAmountArticleType.PRINCIPAL_DEBIT_LEG, DEBIT_SPECIFIC_SECTIONS,
            PaymentAmountArticleType.DISBURSEMENT_CREDIT, CREDIT_SPECIFIC_SECTIONS);

    @Override
    public List<MetadataSection> getMetadataSections(PaymentAmountArticleType articleType) {
