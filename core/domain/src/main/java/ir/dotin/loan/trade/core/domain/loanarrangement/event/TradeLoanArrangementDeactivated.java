...
public record TradeLoanArrangementDeactivated(UUID eventId, UUID aggregateId, String eventType, Instant createdAt)
        implements TradeLoanArrangementEvents<TradeLoanArrangementDeactivated> {
