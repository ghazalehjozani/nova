...
public record MorabeheLoanArrangementDeactivated(
        ...
        implements MorabeheLoanArrangementEvent<
                MorabeheLoanArrangementDeactivated, MorabeheLoanArrangementDeactivated.Payload> {

    public MorabeheLoanArrangementDeactivated {
