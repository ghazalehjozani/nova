...
public record MorabeheLoanFacilityPendingApprovalEvent(
        UUID eventId, MorabeheLoanFacilityId aggregateId, Payload payload, Instant createdAt)
        implements MorabeheLoanFacilityEvent<
                MorabeheLoanFacilityPendingApprovalEvent, MorabeheLoanFacilityPendingApprovalEvent.Payload> {
    ...
    public MorabeheLoanFacilityPendingApprovalEvent {
    ...
    public static MorabeheLoanFacilityPendingApprovalEvent of(
            MorabeheLoanFacilityId id, MorabeheLoanApplicationId appId, Clock clock) {
        return new MorabeheLoanFacilityPendingApprovalEvent(
                UUID.randomUUID(), id, new Payload(appId), Instant.now(clock));
    }
