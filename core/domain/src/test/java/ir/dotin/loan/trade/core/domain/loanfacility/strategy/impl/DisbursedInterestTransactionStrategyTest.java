...
@DisplayName("DisbursedInterestTransactionStrategy Test")
...
final class DisbursedInterestTransactionStrategyTest {
    ...
    @Mock
    private CalculationContext<TradeLoanFacility, TradeRelationType, DisbursedInterestArticleType>
    ...
    private void setupBasicMocks() {
        ...
        lenient()
                ...
                .thenReturn(DisbursedInterestArticleType.INTEREST_DEBIT_LEG);
        lenient()
                .when(mockSpecFactory.getCreditArticleType())
                .thenReturn(DisbursedInterestArticleType.INTEREST_CREDIT_LEG);
    }
    ...
    final class ConstructorTests {
        ...
        void shouldThrowExceptionWhenBalanceValidatorIsNull() {
            assertThatThrownBy(() ->
                            new DisbursedInterestTransactionStrategy(mockFindAccountClient, mockSpecFactory, null))
                    .isInstanceOf(NullPointerException.class)
    ...
    final class GenerateDebitsTests {
        ...
        void shouldCallRequiredComponentsWhenGeneratingDebits() {
            given(mockCalculationContext.requireArticleComponent(DisbursedInterestArticleType.INTEREST_DEBIT_LEG))
            ...
            then(mockCalculationContext)
                    .should()
                    .requireArticleComponent(DisbursedInterestArticleType.INTEREST_DEBIT_LEG);
        }
    ...
    final class GenerateCreditsTests {
        ...
        void shouldCallRequiredComponentsWhenGeneratingCredits() {
            given(mockCalculationContext.requireArticleComponent(DisbursedInterestArticleType.INTEREST_CREDIT_LEG))
                    .willReturn(Result.failure(Notification.ofError(
                            TradeLoanFacilityLocalizedMessageCodes.UNEXPECTED_ERROR, "Component not found")));
            ...
            then(mockCalculationContext)
                    .should()
                    .requireArticleComponent(DisbursedInterestArticleType.INTEREST_CREDIT_LEG);
        }
    ...
    final class StrategyInterfaceTests {
        ...
        @Test
        @DisplayName("should implement DisbursedInterestFacilitiesStrategy interface")
        void shouldImplementDisbursedInterestFacilitiesStrategyInterface() {
            assertThat(strategy)
                    .isInstanceOf(
                            ir.dotin.loan.trade.core.domain.loanfacility.strategy.DisbursedInterestFacilitiesStrategy
                                    .class);
        }
        ...
        void shouldBeAFinalClass() {
            assertThat(DisbursedInterestTransactionStrategy.class).isFinal();
        }
    }
}
